(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('@angular/core'), require('@angular/http'), require('@angular/common'), require('rxjs/Rx'), require('rxjs/util/isArray'), require('@angular/core/testing'), require('@angular/http/testing'), require('@angular/platform-browser-dynamic/testing')) :
    typeof define === 'function' && define.amd ? define(['@angular/core', '@angular/http', '@angular/common', 'rxjs/Rx', 'rxjs/util/isArray', '@angular/core/testing', '@angular/http/testing', '@angular/platform-browser-dynamic/testing'], factory) :
    (factory(global._angular_core,global._angular_http,global._angular_common,global.rxjs_Rx,global.rxjs_util_isArray,global._angular_core_testing,global._angular_http_testing,global._angular_platformBrowserDynamic_testing));
}(this, (function (_angular_core,_angular_http,_angular_common,rxjs_Rx,rxjs_util_isArray,_angular_core_testing,_angular_http_testing,_angular_platformBrowserDynamic_testing) { 'use strict';
...
var RikeOperationEvent = (function (_super) {
    __extends$1(RikeOperationEvent, _super);
...
var RikeSuccessEvent = (function (_super) {
    __extends$1(RikeSuccessEvent, _super);
...
var RikeErrorEvent = (function (_super) {
    __extends$1(RikeErrorEvent, _super);
...
var RikeExceptionEvent = (function (_super) {
    __extends$1(RikeExceptionEvent, _super);
...
var RikeErrorResponseEvent = (function (_super) {
    __extends$1(RikeErrorResponseEvent, _super);
...
var RikeCancelEvent = (function (_super) {
    __extends$1(RikeCancelEvent, _super);
...
var CustomProtocol = (function (_super) {
    __extends$3(CustomProtocol, _super);
...
var JsonProtocol = (function (_super) {
    __extends$3(JsonProtocol, _super);
...
var HttpProtocol = (function (_super) {
    __extends$3(HttpProtocol, _super);
...
var StatusCollector = (function () {
    ...
    StatusCollector = __decorate$2([
        _angular_core.Injectable(),
        __param$1(0, _angular_core.Inject(RikeEventSource)),
...
var BaseRikeOptions = (function (_super) {
    __extends$2(BaseRikeOptions, _super);
...
var Rike = (function () {
    ...
    Rike = __decorate$1([
        ...
        __metadata$1('design:paramtypes', [_angular_http.Http, _angular_http.RequestOptions, RikeOptions])
    ], Rike);
    return Rike;
}());
...
var CRUDResource = (function (_super) {
    ...
    CRUDResource.prototype.objectReadProtocol = function (id) {
        var _this = this;
        return this.rikeTarget.protocol.prior().prepareRequest(function (options) { return new _angular_http.RequestOptions(options).merge({
    ...
    CRUDResource.prototype.objectUpdateProtocol = function (object) {
        ...
        return this.rikeTarget.protocol
            .prior()
            .updateRequest(function (object, options) { return new _angular_http.RequestOptions(options).merge({
...
describe("Protocol", function () {
    ...
    it("prepares request before", function () {
        var proto = protocol.prior().prepareRequest(function (opts) { return new _angular_http.RequestOptions(opts).merge({ search: "updated=true" }); });
    ...
    it("prepares request after", function () {
        var proto = protocol.then().prepareRequest(function (opts) { return new _angular_http.RequestOptions(opts).merge({ search: "updated=true" }); });
        var opts = proto.prepareRequest({});
        expect(opts.url).toBe("/request");
    ...
    it("writes request", function () {
        var proto = protocol.instead().writeRequest(function (request, opts) {
            return new _angular_http.RequestOptions(opts).merge({ body: request.request2 });
        });
    ...
    it("updates request before it is written", function () {
        var proto = protocol.prior().updateRequest(function (request, opts) {
            ...
            return new _angular_http.RequestOptions(opts).merge({ body: request });
        });
    ...
    it("reads response", function () {
        ...
        var response = proto.readResponse(new _angular_http.Response(new _angular_http.ResponseOptions()));
    ...
    it("handles error", function () {
        ...
        var error = proto.handleError({ response: new _angular_http.Response(new _angular_http.ResponseOptions()) });
...
describe("JSON protocol", function () {
    ...
    it("reads response", function () {
        ...
        var read = protocol.readResponse(new _angular_http.Response(new _angular_http.ResponseOptions({
...
describe("Rike", function () {
    ...
    function loadRequestTest(method, read) {
        return function (done) {
            back.connections.subscribe(function (connection) {
                ...
                connection.mockRespond(new _angular_http.Response(new _angular_http.ResponseOptions({
                    body: "response1",
                })));
            });
            var succeed = false;
    ...
    it("processes PATCH request", sendRequestTest(_angular_http.RequestMethod.Patch, function (rike) { return rike.patch; }));
    ...
    it("creates target with specified protocol", function () {
        var protocol = jsonProtocol()
            ...
            return new _angular_http.RequestOptions(opts).merge({ body: val });
        });
        var targetId = "target1";
...
describe("requestMethod", function () {
    it("GET", requestMethodTest(_angular_http.RequestMethod.Get, "GeT"));
    it("POST", requestMethodTest(_angular_http.RequestMethod.Post, "pOSt"));
    it("PUT", requestMethodTest(_angular_http.RequestMethod.Put, "put"));
    it("DELETE", requestMethodTest(_angular_http.RequestMethod.Delete, "deletE"));
    it("OPTIONS", requestMethodTest(_angular_http.RequestMethod.Options, "OPTIONS"));
    it("HEAD", requestMethodTest(_angular_http.RequestMethod.Head, "hEad"));
    it("PATCH", requestMethodTest(_angular_http.RequestMethod.Patch, "pAtch"));
    it("specified as is", requestMethodTest(_angular_http.RequestMethod.Post, _angular_http.RequestMethod.Post));
...
describe("RikeOperation", function () {
    ...
    it("processes PATCH request", sendRequestTest(_angular_http.RequestMethod.Patch, function (op) { return op.patch; }));
    it("loads with GET by default", loadRequestTest(_angular_http.RequestMethod.Get, function (op) { return op.load; }));
    it("loads with specified method", loadRequestTest(_angular_http.RequestMethod.Options, function (op) { return op.withMethod("options").load; }));
    ...
    it("sends with specified method", sendRequestTest(_angular_http.RequestMethod.Put, function (op) { return op.withMethod("put").send; }));
...
describe("RikeTarget", function () {
    ...
    it("creates operation over specified protocol", function () {
        var proto = jsonProtocol()
            .instead()
            .writeRequest(function (val, opts) {
            return new _angular_http.RequestOptions(opts).merge({ body: JSON.stringify(val) });
        });
