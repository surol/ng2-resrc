(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('@angular/core'), require('@angular/http'), require('@angular/common'), require('rxjs/util/isArray'), require('rxjs/Rx'), require('rxjs/Subject'), require('rxjs/ReplaySubject'), require('@angular/core/testing'), require('@angular/platform-browser-dynamic/testing'), require('@angular/http/testing')) :
	typeof define === 'function' && define.amd ? define(['@angular/core', '@angular/http', '@angular/common', 'rxjs/util/isArray', 'rxjs/Rx', 'rxjs/Subject', 'rxjs/ReplaySubject', '@angular/core/testing', '@angular/platform-browser-dynamic/testing', '@angular/http/testing'], factory) :
	(factory(global._angular_core,global._angular_http,global._angular_common,global.rxjs_util_isArray,global.rxjs_Rx,global.Rx,global.rxjs_ReplaySubject,global._angular_core_testing,global._angular_platformBrowserDynamic_testing,global._angular_http_testing));
}(this, (function (_angular_core,_angular_http,_angular_common,rxjs_util_isArray,rxjs_Rx,rxjs_Subject,rxjs_ReplaySubject,_angular_core_testing,_angular_platformBrowserDynamic_testing,_angular_http_testing) { 'use strict';
...
var Rike = (function () {
    function Rike(_http, defaultHttpOptions, _options) {
        var _this = this;
        this._http = _http;
        this._rikeEvents = new rxjs_Subject.Subject();
        this._uniqueIdSeq = 0;
...
var RikeTargetImpl = (function (_super) {
    ...
    function RikeTargetImpl(_rike, _internals, _target, _protocol) {
        ...
        _this._rikeEvents = new rxjs_Subject.Subject();
...
var FieldEmitter = (function () {
    function FieldEmitter(_field, _emitters, _targetErrors) {
        ...
        this._emitter = new rxjs_ReplaySubject.ReplaySubject(1);
        this._counter = 0;
    }
...
var RikeResource = (function (_super) {
    __extends$4(RikeResource, _super);
...
describe("RikeOperation event", function () {
    ...
    it("exception", _angular_core_testing.fakeAsync(function () {
